    ...
    private  Runnable _r_getdims = new Runnable() {
        ...
        public void run() {
            ...
            if(dw == 0 || dh == 0) {
                ...
                Log.i("T MGAME GDIM", "LETS GET THE SIZE!");
                ...
                if (w != 0 && h != 0) {
                    ...
                    Log.i("T MGAME GDIM", "SIZE OBTAINED, X: " + w);
                    ...
                    Log.i("T MGAME GDIM", "FAILED, LETS DO IT AGAIN!");
                ...
                Log.i("T MGAME GDIM", "SIZE ARE ALREADY ESTABLISHED");
    ...
    private Runnable _r_animate = new Runnable() {
        ...
        public void run() {
            ...
            if(_i < _b.length) {
                ...
                Log.i("T MGAME ANIMATE", "ANIMATION ASSIGNED TO BUTTON: " + _i);
                Log.i("T MGAME ANIMATE", "WAIT TIME: " + wait);
                ...
                Log.i("T MGAME", "ANIMATION ASSIGNED TO ALL BUTTONS.");
...
//        catch (NoSuchAlgorithmException e) { }
    ...
    public void setListeners(){
        ...
        _b_min.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("T MGAME B1MIN", "BUTTON 1 MIN PRESSED");
        ...
        _b_tap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("T MGAME B100TAP", "BUTTON 100 TAP PRESSED");
        ...
        _b_single.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("T MGAME BCBIND", "BUTTON CBIND PRESSED");
        ...
        findViewById(R.id.ib_stats).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("T MGAME BSTATS", "BUTTON STATS PRESSED");
        ...
        findViewById(R.id.ib_achievements).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("T MGAME BACHIEVEMENTS", "BUTTON ACHIEVEMENTS PRESSED");
        ...
        findViewById(R.id.ib_leaderboards).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("T MGAME BLEADERBOARDS", "BUTTON LEADERBOARDS PRESSED");
        ...
        findViewById(R.id.ib_info).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("T MGAME BINFO", "BUTTON SETTINGS PRESSED");
            }
    ...
    public void updateAchievements(){
        ...
        for(int i = 0; i < names.length; i++) {
            ...
            Log.i("T GAME UACHIEVEMENT", "CURRENT COLOR CHECK: " + current);
            Log.i("T GAME UACHIEVEMENT", "MAX: " + max[i]);
            Log.i("T GAME UACHIEVEMENT", "READACHIEVEMENTDATA: " + GM.readAchievementData(_a, state[i]));
        ...
        try {
            ...
            dlg_dif.setAdapter(adapter, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Log.i("T MGAME DLGDIF", "WHICH DIFFICULTY VALUE: " + getResources().getStringArray(R.array.difficulty_s)[which]);
                    clearAnimations();
    ...
    public void createDlgColor() {
        ...
        try {
            ...
            Log.i("T MGAME DLGCOLOR", "CREATED");
    ...
    public void clearAnimations(){
        ...
        Log.i("T MENU CLANIMATION", "CALLBACKS OF ANIMATION REMOVED");
    ...
    /*--METHODS-----------------------------------------------------------------------------------*/
        ...
        /*--LOG-----------------------------------------------------------------------------------*/
            ...
            Log.i("T CDIALOG CLICK", "CORRECT COLOR ID: " + GM.COLORS[p]);
        ...
        public void setListeners(){
            ...
            _exit   .setOnClickListener(new View.OnClickListener() {
                ...
                /*--LOG---------------------------------------------------------------------------*/
                    ...
                    Log.i("T CDIALOG EXIT", "EXITING COLORDIALOG");
