 ...
 * 18/Mar/16:                   -Edited the setCombo method so it doesnt work in tap mode.
 */
...
public class A_Game extends AppCompatActivity {
    ...
    private Runnable _r_setsize = new Runnable() {
        ...
        public void run() {
            ...
            if(GM.readConf(_a, GM.C_BISIZE) == 0) {
                ...
                Log.i("T GAME GSIZEB", "HEIGHT WRITTEN: " + d);
                ...
                Log.i("T GAME GSIZEB", "SIZE OBTAINED: " + size);
            }
                ...
                if(!_a_tv_game_ready_fadein.isInitialized()) {
                    ...
                    for(int i = 0; i < GM.S_6 + 1; i++)
                        while(GM.readConf(_a, GM.C_SIZESX[i]) == 0) {
                            Log.i("T GAME TTICK", "SETBLOCKSIZE EXECUTED FOR: " + i);
    ...
    Runnable _r_hide = new Runnable() {
        ...
        public void run() {
            ...
            Log.i("T GAME RHIDE", "_tv_combo_2 visibility is now gone.");
        }
...
/*--METHODS---------------------------------------------------------------------------------------*/
	...
	public void declare() {
		...
		Log.i("T GAME DECLARE", "DIFFICULTY: " + getResources().getStringArray(R.array.difficulty_s)[_g_difficulty]);
        Log.i("T GAME DECLARE", "GAMEMODE [0=MIN], [1=TAP], [2=SMIN], [3=STAP]: " + _g_gamemode);
		...
		if (_g_game_started && !_tapcheck) {
			...
			if (wascorrect) {
                if(_g_gamemode == GM.GM_CMIN || _g_gamemode == GM.GM_MIN) {
                    ...
                    Log.i("G GAME CHECKTAP", "SCORE INCREASED BY: " + (_g_points_per_hit * _g_combo));
                }
                else {
                    _g_score++;
                    _g_cutsec++;
                    ...
                    if(_g_cutsec == 5) {
                        ...
                        Log.i("T GAME CHECKTAP", "CUTSEC ACTIVATED");
                    }
                }
				...
				if(_s_streak > _s_lstreak){
					...
					Log.i("T GAME CHECKTAP", "LONGEST STREAK: " + _s_lstreak);
				}
				Log.i("G GAME CHECKTAP", "HITS: " + _s_hits            );
				Log.i("G GAME CHECKTAP", "CURRENT STREAK: " + _s_streak);
			} else {
				/*--NOT CORRECT-------------------------------------------------------------------*/
				if(_g_difficulty == GM.DIF_EX){
					...
					_tv_timer.setText(String.valueOf(_g_time));
					Log.i("G GAME CHECKTAP", "GAME ENDED WITH EXTREME DIFFICULTY");
				} else {
                    if(_g_gamemode == GM.GM_CMIN || _g_gamemode == GM.GM_MIN) {
					...
					_s_streak = 0;
                    setCombo();
                    Log.i("G GAME CHECKTAP", "ERROR, STREAK IS NOW 0: " + _s_streak         );
					Log.i("G GAME CHECKTAP", "ERROR, LOST: " + _g_points_per_hit + " POINTS");
				}
            }
            _tapcheck = true;
            setFullLayout();
	...
	public void setCombo(){
        ...
        if(_g_gamemode == GM.GM_MIN || _g_gamemode == GM.GM_CMIN) {
            ...
            Log.i("T GAME SCOMBO", "COMBO VALUE: " + _g_combo);
    ...
    public void updateGameData(){
        ...
        if(_s_hits == (_s_total - 1) && _s_total > 1) {
            ...
            Log.i("T GAME END STATS", "PERFECT GAMES INCREASED: " + perfectg);
        }
        ...
        if(_s_lstreak > datastreak) {
            ...
            Log.i("T GAME END STATS", "LONGEST STREAK UPDATED: " + _s_lstreak);
        }
        ...
        Log.i("T GAME END STATS", "NOGAMES: " + nogames);
    ...
    public void setFullLayout() {
        ...
        Log.i("T GAME SFULLLAYOUT", "FIRST APPEARANCE VALUE: " + _first_appearance);
        ...
        Log.i("T GAME SCOLOR", "TOTAL BLOCKS CREATED: " + _s_total);
    ...
    public void setBlocksLayout() {
        ...
        int D    = R.nextInt(9);
        int size = 0;
        Log.i("T GAME SBLCKLAYOUT", "D VALUE: " + D);
        Log.i("T GAME SBLCKLAYOUT", "DIFFICULTY: " + _g_difficulty);
        ...
        Log.i("T GAME SBLCKLAYOUT", "USED SIZE: " + used.length);
        ...
        if(unused != null) {
            ...
            Log.i("T GAME SBLCKLAYOUT", "UNUSED SIZE: " + unused.length);
    ...
    public void setBlockSize(int oSize, boolean oResize) {
        ...
        Log.i("T GAME SBLCKSIZE", "BSIZE VALUE, FIRST TRY: " + sizex );
        Log.i("T GAME SBLCKSIZE", "MARGIN FOR Y, FIRST TRY: " + sizey);
        Log.i("T GAME SBLCKSIZE", "MARGIN FOR x, FIRST TRY: " + margx);

        /*--IF WE DONT HAVE SIZES, GET THEM-------------------------------------------------------*/
        if(sizex == 0 || sizey == 0) {
            Log.i("T GAME SBLCKSIZE", "NO SIZE YET, LETS GET IT");
            int w = _ll_container.getWidth( );
            int h = _ll_container.getHeight();
            Log.i("T GAME SBLCKSIZE", "WIDTH: " + w );
            Log.i("T GAME SBLCKSIZE", "HEIGHT: " + h);
            ...
            Log.i("T GAME SBLCKSIZE", "SIZE FOR X: " + sizex);
            Log.i("T GAME SBLCKSIZE", "MARGIN FOR X: " + margx);

            /*--MARGIN FOR Y----------------------------------------------------------------------*/
            sizey = h / nblocks;
            Log.i("T GAME SBLCKSIZE", "SIZE FOR Y: " + sizey);
            ...
            Log.i("T GAME SBLCKSIZE", "VALUES WRITTEN IN FILE: " + GM.C_SIZESX[oSize] + ", " +
                    GM.C_SIZESY[oSize] + "and " + GM.C_BMARGINX[oSize]);
        }
        else {
    ...
    public void setCorrectColor(){
        ...
        if(_g_gamemode == GM.GM_CMIN || _g_gamemode == GM.GM_CTAP) {
            ...
            Log.i("T GAME SETCCOLOR", "CORRECT BUTTON POS: " + b_correct_pos);
