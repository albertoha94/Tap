...
public class GM {
	...
	public static Row[] readLeaders(Context OCon, String OFile){
		...
		try {
            ...
            Log.i("T GM", "READ LEADERBOARDS, FILENAME: " + OFile);
			...
			if (inputStream != null) {
				...
				for(int i = 0; i < r.length; i++) {
                    ...
                    Log.i("T GM", "READ LEADERBOARDS, ROW RETURNING: " + r[i].toString());

                }

                /*--LOG---------------------------------------------------------------------------*/

                Log.i("T GM", "READ LEADERBOARDS, SUCCESSFUL");
            ...
            Log.i("T GM", "READ LEADERBOARDS FAILED, USED CATCH");
	...
	public static void writeLeaders(Context OCon, String OFile, Row[] ORows){
		...
		try {
            ...
            Log.i("T GM", "WRITE LEADERBOARDS, FILENAME: " + OFile);
			...
			while(i < ORows.length) {
                ...
                Log.i("T GM", "WRITE LEADERBOARDS, DATA WRITTEN IN: " + i + ": " + ORows[i].toString());
            ...
            Log.i("T GM", "WRITE LEADERBOARDS, SUCCESSFUL");
    ...
    public static void insertRow(Context OCon, String OFile, Row ORow) {
        ...
        Log.i("T GM", "INSERT ROW, FILENAME: " + OFile);
        ...
        if(gamemode == GM_MIN || gamemode == GM_CMIN) {
            ...
            for (int i = 0; i < data.length; i++)
                if (ORow.get_score() > data[i].get_score()) {
                    ...
                    Log.i("T GM", "INSERT ROW, DATA WRITTEN IN: " + i);
        ...
        Log.i("T GM", "INSERT ROW, ROW INSERTED");
