 ...
 *                              different length.
 *                              -Removed logs.
 * 19/Mar/16:                   -Added an adview, adrequest and the method createAd.
 *                              -Added the appjolt methods.
 */
...
//        catch (NoSuchAlgorithmException e) { }
    ...
    /**
     * Summary:                 Method that loads the button clicks used in the activity from both,
    ...
    /**
     * Summary:                 Used to load an ad at the start of the activity.
     */
    public void createAd() {

        _AdMenu    = (AdView)findViewById(R.id.adView);
